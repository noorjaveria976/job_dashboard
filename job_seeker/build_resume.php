...
<body>
  ...
  imageInput.addEventListener('change', (event) => {
    ...
    <div class="modal fade" id="experienceModal" tabindex="-1" role="dialog" aria-labelledby="formModal2"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form class="form" id="add_edit_profile_experience" method="POST" action="https://www.sharjeelanjum.com/demos/jobsportal-update/store-front-profile-experience/6"><input type="hidden" name="_token" value="6yWsZRaRmexsWsKMZhvrp1XB4w6hgjC2GUPscb02" autocomplete="off">
    ...
    <script>
        ...
        // submit form
        $("#add_edit_profile_project").submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (res.success) {
                        alert(res.message);
                        $("#projectModal").modal("hide");
                        showProjects(); // data refresh karega
                    } else {
        ...
        // Edit project
        function showProfileProjectEditModal(id) {
            $.ajax({
                url: "get_project.php",
                type: "GET",
                data: {
                ...
                success: function(response) {
                    ...
                    if (data.success) {
                        ...
                        $("#url").val(data.project.url);
                        $("#date_start").val(data.project.date_start);
                        $("#date_end").val(data.project.date_end);
                        $("#description").val(data.project.description);

                        if (data.project.is_on_going == 1) {
                        ...
                        if (data.project.image) {
                            $("#previewImage").attr("src", data.project.image).show();
                            $("#uploadText").hide();
                        }
