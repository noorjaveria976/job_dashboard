ye mery "profile.php" ki file h is ko jb mny create kia tha tb ye load ho rha tha or ab bhi ho rha h but agr new user login ho k is page ko access krta h to ye load hi nhi hota dekho kia issue h "<?php
session_start();
...
ye mery "profile.php" ki file h is ko jb mny create kia tha tb ye load ho rha tha or ab bhi ho rha h but agr new user login ho k is page ko access krta h to ye load hi nhi hota dekho kia issue h " <div class="col-md-9 col-sm-8">
