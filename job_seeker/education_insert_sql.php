...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO job_seeker_education (
                user_id, degree_level_id, degree_type_id, degree_title, major_subjects,
                country_id, state_id, city_id, institution, date_completion,
                degree_result, result_type_id, created_at
            ) VALUES (
                '$user_id', '$degree_level_id', '$degree_type_id', '$degree_title', '$major_subjects',
                '$country_id', '$state_id', '$city_id', '$institution', '$date_completion',
                '$degree_result', '$result_type_id', NOW()
            )";
